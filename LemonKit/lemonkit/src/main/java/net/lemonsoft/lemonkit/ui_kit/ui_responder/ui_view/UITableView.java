...
public class UITableView extends UIScrollView {
    ...
    private UITableViewDelegate delegate;// 代理
    private UITableViewDataSource dataSource;// 数据源

//    public UITableView() {
////        super(UIScrollView.class);
//    }
//
//
...
//        initTableView();
//        this.setDelegate(new UIScrollViewDelegateAdapter() {
//            @Override
...
//        _gRV().scrollToX(x, animated);
//    }
//
//
//    public void scrollToY(float y, boolean animated) {
//        _gRV().scrollToY(y, animated);
//    }
//
//
...
//        if (this.delegate != null)
//            delegate.heightForHeaderInSection(this, section);
//        return null;
//    }
//
//
...
//        if (this.delegate != null)
//            delegate.heightForFooterInSection(this, section);
//        return null;
//    }
//
//
...
//        if (this.delegate != null)
//            delegate.editActionsForRowAtIndexPath(this, indexPath);
//        return null;
//    }
//
//
...
//            dataSource.numberOfRowsInSection(this, section);
//        return null;
//    }
//
//
...
//        if (this.dataSource != null)
//            dataSource.cellForRowAtIndexPath(this, indexPath);
//        return null;
//    }
//
//
...
//        if (this.dataSource != null)
//            dataSource.numberOfSectionsInTableView(this);
//        return null;
//    }
//
//
...
//        if (this.dataSource != null)
//            dataSource.titleForHeaderInSection(this, section);
//        return null;
//    }
//
//
...
//        if (this.dataSource != null)
//            dataSource.titleForFooterInSection(this, section);
//        return null;
//    }
//
//
...
//        if (this.dataSource != null)
//            dataSource.viewForHeaderInSection(this, section);
//        return null;
//    }
//
//
...
//        if (this.dataSource != null)
//            dataSource.viewForFooterInSection(this, section);
//        return null;
//    }
//
...
//    private HashMap<String, UITableViewCell> frontCellPool;// 正在显示的cell的父View池
//
//    private RelativeLayout contentView;// 正文控件，实际所有的cell都放到这个view中
//
//    ///// 复用机制池 -- 开始
//
//    private HashMap<String, ArrayList<UITableViewCell>> reuseCellPool;// cell复用机制池
...
//     */
//    private UITableViewCell initCell(final LKIndexPath indexPath, Integer cellHeight, Integer y) {
...
//                        // 调用action点击事件
//                        action.getTouchAction().onTouch(UITableView.this, action, indexPath);
//                        closeCurrentSlide();
//                    }
//                });
...
//                delegate.didSelectRowAtIndexPath(UITableView.this, indexPath);// 调用代理中的行点击事件
//            }
//        });
//        UITableViewCell cell = dataSource.cellForRowAtIndexPath(this, indexPath);
...
//            UITableViewCell cell = frontCellPool.get(pathInfo);
//            if (cell != null) {// 不是null
...
//                    reuseCellPool.put(cell.getReuseIdentifier(), new ArrayList<UITableViewCell>());// 那么重新创建一个list放到复用池中
...
//            UITableViewCell cell = reuseCellPool.get(identifier).get(0);
